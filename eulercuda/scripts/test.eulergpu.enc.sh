...
outputDir=./$dirPrefix
eulerCudaApp=/home/smahmood/test/phase2/parenc/eulercuda/bin/linux/release/eulercuda
inputDir=$1
origDir=$2
seqK=`seq 21 2 31`
seqBlock="512"
seqR="36bp 50bp 256bp"
...
do
#echo $r
	for f in $inputDir/*$r.fas*					# iterate over each input
	do 
#		echo $f
		...
		#	echo "$k $fileBaseName"
			...
			do
				...
				T1=`date +%s.%N`
				$eulerCudaApp $f  $outputFile  $kmer $block $r  1>>$statFile  2>> $logFile		# Run CUDA
				T2=`date +%s.%N`
